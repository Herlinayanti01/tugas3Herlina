...
public class DataProvider {
    ...
    private static List<Monyet> initDataMonyet(Context ctx) {
        ...
        monyets.add(new Monyet("monyet_bekantan", "kalimantan",
                "monyet bekantan adalah jenis monyet berhidung panjang dengan rambut berwarnat coklat dan salah satu dari 2 spesies nasalis. ", R.drawable.monyet_bekantan));
        monyets.add(new Monyet("monyet_owa_jawa", "jawa",
                "monyet owa jawa merupakan primata endemik ciri khasnya tidak memiliki ekor,berkepala kecil,dan memiliki bantalan ", R.drawable.monyet_owa_jawa));
        monyets.add(new Monyet("monyet_daun_natuna", "natuna",
                "monyet daun natuna bentuknya sangat lucu dan unik tubuhnya dibaluti dengan bulu hitam yang diselingi oleh warna putih", R.drawable.monyet_daun_natuna));
        monyets.add(new Monyet("monyet_tarsisus_kecil", "sulawesi",
                "Adalah jenis monyet kecil panjang 15 cm dengan berat badan 80 gr ", R.drawable.monyet_tarsius_kecil));
